...
## Tests
    ...
    assert.equal 16, versionSum parse '8A004A801A8002F478'
    assert.equal 12, versionSum parse '620080001611562C8802118E34'
    assert.equal 23, versionSum parse 'C0015000016115A2E0802F182340'
    assert.equal 31, versionSum parse 'A0016C880162017C3686B18A3D4780'
